                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Hallo Pengguna Baru ! <br>
                                Silahkan Registasi Sekarang</h3>

                            <?php Message::getTemplateMessage(); ?>
                            <form method="POST" action="<?= BASEURL . 'account/proses_register' ?>">
                                <div class="col-md-12 form-group p_star">

                                    <input id="nama" type="text" class="form-control" name="nama" required autofocus placeholder="Nama">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <a class="lost_pass" href="<?= BASEURL . 'account' ?>">
